...
class ProductoItemCarrito extends StatelessWidget {
  const ProductoItemCarrito({Key? key, this.model, this.onDelete})
      : super(key: key);
        ...
        children: [
          ...
          Container(
            ...
            child: GestureDetector(
              child:
                  const Icon(Icons.delete, size: 30, color: Colors.redAccent),
              onTap: () {
                print("Delete|");
                showDialog(
                    context: context,
